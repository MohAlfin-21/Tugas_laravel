...
<div class="card" style="max-width:700px; margin:0 auto;">
    <div class="page-title">✏️ Edit Data Siswa</div>
    ...
    <form method="POST" action="{{ route('siswa.update', $siswa) }}" id="form-edit-siswa">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <textarea id="alamat" name="alamat" placeholder="Alamat lengkap siswa...">{{ old('alamat', $siswa->alamat) }}</textarea>
